...
export default function UpdateGraduates({
  ...
  return (
    <>
      ...
      <dialog
        ref={modalRef}
        className="rounded-2xl w-full max-w-4xl shadow-2xl m-auto backdrop:bg-black/60"
      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <fieldset className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("fechaEgreso", e.target.value)
                        }
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-3 focus:ring-green-500/50 focus:border-green-500 transition-all duration-200 bg-white shadow-sm"
                      />
                    </fieldset>
            ...
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex-shrink-0">
              <div className="flex justify-end gap-4">
                <button
                  type="button"
                  onClick={() => modalRef.current?.close()}
                  className="px-6 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 transition-all duration-200"
                >
                  Cancelar
                </button>
                <button
